...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = '00.data';
    var REMOTE_PACKAGE_BASE = '00.data';
...
Module['FS_createPath']('/', 'assets', true, true);
        ...
        DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_00.data');

    };
    Module['addRunDependency']('datafile_00.data');
 ...
 loadPackage({"files": [{"start": 0, "audio": 0, "end": 482, "filename": "/assets/bug.png"}], "remote_package_size": 482, "package_uuid": "0205227f-6f36-463d-8ab7-0e9d45cc3b4c"});
...
function integrateWasmJS() {
  ...
  var wasmTextFile = '00.wast';
  var wasmBinaryFile = '00.wasm';
  var asmjsCodeFile = '00.temp.asm.js';
...
Module['wasmTableSize'] = 32000;

Module['wasmMaxTableSize'] = 32000;
